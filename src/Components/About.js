        ...
        <div className="col-lg-6 offset-lg-0 ">
          ...
          <ul className="theme-list">
            ...
            <li className="color-green">
              <b>Age:</b> <span style={{ color: "white" }}>25</span>
            </li>
            <li>
        ...
        <div className="row ">
          <div className="col-md-6 color-white">
            ...
            <ul className="timeline mt-4 pr-md-5">
              <li>
                <div className="title">2020-22</div>
                <div className="details">
                  <h5 className="color-blue">
                    CMA (Cost And Management Accounting)
                  </h5>
                  <small className="">
                    Institute of Cost And Management Accounts of India,Bangalore
                  </small>
                </div>
              </li>
              &nbsp;
          ...
          <div className="col-md-6 color-white">
            <h2 className="fw-normal">Certifications</h2>
            <ul className="timeline mt-4 pr-md-5">
              <li>
                <div className="title">2022-23</div>
                <div className="details">
                  <h5 className="color-blue">Full Stack Development</h5>
                  <small className="">
                    Full Stack Development in MERN Stack from GUVI Geek
          ...
          >
            ...
            <ul className="timeline mt-4 pr-md-5">
              <li>
                <div className="title">2019-20</div>
                <div className="details">
